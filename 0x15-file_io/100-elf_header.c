...
/**
* print_magic - Prints magic no. of an ELF header.
* @e_ident Array containing the ELF magic numbers.
*
* Description: Magic no. separated by spaces.
*/
void print_magic(unsigned char *e_ident)
{
int index;
...
/**
*  * print_version - version of an ELF header print.
...
/**
* print_abi - ABI version of an ELF header print.
* @e_ident: A pointer to an array containing ELF ABI version.
*/
void print_abi
...
* ELF header at the start.
* @argc: The no. of argc supplied to the program.
